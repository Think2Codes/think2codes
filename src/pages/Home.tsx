...
export default function Home() {
  ...
  const startCounting = () => {
    ...
    counters.forEach((counter) => {
      ...
      const duration = 2; 
      const stepTime = Math.max(Math.floor(duration / target), 0.2);
      let current = 0;
  ...
  const handleAIConnect = () => {
    if (!apiKey.trim()) {
      toast({
        ...
        description:
          "Please enter your OpenAI API key to connect AI Analytics.",
        variant: "destructive"
      });
      return;
    }
  ...
  const heroSlides = [
    {
      ...
      description:
        "Write code, get instant AI feedback, and level up your programming skills through gamified learning experiences.",
      icon: <Code className="h-16 w-16" />
    },
    {
      title: "Real-time Code Analysis",
      description:
        "Our AI analyzes your code in real-time, providing instant feedback and corrections to help you learn faster.",
      icon: <Zap className="h-16 w-16" />
    },
    {
      title: "Gamified Learning Experience",
      description:
        "Unlock achievements, level up your skills, and compete with other developers in our interactive coding challenges.",
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-hero">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
                <Link to="/" className="w-full sm:w-auto">
                  <Button
                    ...
                    size="xl"
                    className="w-full"
                    onClick={() => (window.location.hash = "#code-editor")}
                  >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
              {features.slice(0, 4).map((feature, index) => (
                <Card
                  key={index}
                  className="shadow-card border-border/50 hover:shadow-glow transition-smooth"
                >
        ...
        <section ref={sectionRef} className="py-12 sm:py-16 px-4 bg-muted/30">
